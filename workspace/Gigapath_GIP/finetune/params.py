...
def get_finetune_params():
    ...
    parser.add_argument('--loss_fn',        type=str, default='mse', help='Which loss to use in continuous setting', choices=['mse', 'mae', 'huber', 'logcosh', 'cox', 'trunc_mse', 'weighted_mse'])
