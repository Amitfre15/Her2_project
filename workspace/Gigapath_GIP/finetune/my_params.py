...
def get_finetune_params():
    ...
    # task settings
    parser.add_argument('--task_cfg_path',  type=str, default='/home/amitf/workspace/Gigapath_GIP/finetune/task_configs/Her2.yaml', help='Path to the task configuration file')
    ...
    # input data settings
    parser.add_argument('--dataset_csv',    type=str, default='/home/amitf/workspace/WSI/metadata_csvs/Her2_slides_matched_HE_folds.csv', help='Dataset csv file')
    ...
    parser.add_argument('--label',          type=str, default='label', help='Column name of the label')
    parser.add_argument('--train_dataset',  type=parse_list, default=[], help='Name of datasets to train on')
    ...
    parser.add_argument('--train_fold',     type=parse_list, default=[1,2,3,4,5], help='Folds to train on')
    parser.add_argument('--val_fold',       type=parse_list, default=[], help='Folds to train on')
